...
class Feeder_Buddypress {
	...
	public function __construct( $user ) {
		...
		add_filter( 'bp_notifications_get_registered_components', [ $this, 'feeder_filter_notifications_get_registered_components' ] );
	 ...
	 */
	public function feeder_filter_notifications_get_registered_components() {
...
$feeder_buddypress = new Feeder_Buddypress( $user );
